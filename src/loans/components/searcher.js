        ...
        <div className="searcher">
            ...
            <div className="searcher_3">
                <select value={props.country} onChange={handleChangeCountry}>
                    {props.labels[3].countries.map((data) => <option key={data.key} value={data.key}>{data.value}</option>)}
                </select>
            </div>
            <div className="searcher_4">
                <select value={props.method} onChange={handleChangeMethod}>
                    <optgroup label="Loan Method">
                        {props.labels[1].label.searchList[0].list.map((data) => <option key={data.key} value={data.key}>{data.value}</option>)}
                    </optgroup>
                    <optgroup label="Loan form">
                        {props.labels[1].label.searchList[1].list.map((data) => <option key={data.key} value={data.key}>{data.value}</option>)}
                    </optgroup>
                </select>
            </div>
            <div className="searcher_5">
                <button>{props.labels[1].label.search}</button>
            </div>
        </div> 
...
export default connect(mapStateToProps, { showUsers })(Searcher)